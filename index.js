...
/* 	GÖREV 3:
    ...
    sayilar dizisi içerisinde birden fazla kez yazılmış sayıları tespit ederek kaç kere tekrar edildiğini belirten bir string oluşturulup `tekraredensayilar` dizisine aktarılmasını istiyoruz. 
    ...
    bu görevi yapabilmek için en az 2 kere döngü yazmalısınız. Birinci döngüde hangi sayının kaç kere tekrar edildiğini tespit edip, 2. döngüde stringi oluşturup verilen diziye aktarmalısınız.
*/
...
//  enbuyuk = sayilar[i]> enbuyuk ? sayilar[i]: enbuyuk;
 ...
 console.log(`en buyuk : ${enbuyuk} enkucuk : ${enkucuk}`);
...
/* kodlar buraya */
 ...
 console.log(ucetambolunenler.length)

// 3c çözümü:

/* kodlar buraya */
   ucebolunenlerintoplami = ucetambolunenler.reduce((sayi, yeni)=> sayi+yeni,0);
...
// 1. Döngü: Sayıların kaç kere tekrar edildiğini tespit et
sayilar.forEach((sayi) => {
...
// 2. Döngü: Tekrar edilen sayılar için stringleri oluştur ve tekraredensayilar dizisine ekle
